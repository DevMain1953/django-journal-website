...
urlpatterns = [
    ...
    path("accepted_articles/<int:number_of_page>", views.display_page_with_accepted_articles, name="accepted_articles_with_pagination"),
    ...
    path("scientific_publication/<int:pk_of_scientific_publication>/add_article", views.add_article, name="add_article_to_scientific_publication"),
